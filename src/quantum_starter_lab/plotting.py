...
def plot_histogram(counts: Dict[str, int], ax=None, title: str = "Measurement Outcomes"):
...
def create_summary_plot(counts: Dict[str, int], circuit_diagram: str, title: str):
    ...
    ax1.text(0.5, 0.5, circuit_diagram, ha='center', va='center', fontfamily='monospace', fontsize=12)
    ax1.axis('off')
